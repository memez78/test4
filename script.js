...
function viewTrip(tripId) {
    ...
    // Set up reveal animation class
    document.documentElement.style.setProperty('--reveal-animation', 'none');
...
function revealDestination() {
    ...
    if (choice) {
        ...
        document.documentElement.style.setProperty('--reveal-animation', 'reveal 1s ease-in-out forwards');
        
        // Play reveal sound
        const revealSound = new Audio('https://assets.mixkit.co/active_storage/sfx/2571/2571-preview.mp3');
        revealSound.play().catch(e => console.log('Audio playback failed:', e));
